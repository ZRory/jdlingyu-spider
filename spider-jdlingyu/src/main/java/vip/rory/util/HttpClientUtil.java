...
public class HttpClientUtil {
	...
	// 连接池连接最大数
	private final Integer MAX_CONNECTION_NUM = 1000;
	// 最大路由，
	...
	private final Integer MAX_PER_ROUTE = 1000;
	// 握手超时时间
	private final Integer SOCKET_TIMEOUT = 20000;
	// 连接请求超时时间
	private final Integer CONNECTION_REQUEST_TIMEOUT = 40000;
	// 连接超时时间
	private final Integer CONNECTION_TIMEOUT = 40000;
